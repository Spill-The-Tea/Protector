...
#define DEFAULTVALUE_KNIGHT_ENDGAME    (395)
#define DEFAULTVALUE_BISHOP_OPENING    (363)
#define DEFAULTVALUE_BISHOP_ENDGAME    (411)
#define DEFAULTVALUE_ROOK_OPENING      (583)
#define DEFAULTVALUE_ROOK_ENDGAME      (622)
#define DEFAULTVALUE_QUEEN_OPENING     (1154)
#define DEFAULTVALUE_QUEEN_ENDGAME     (1191)

#define DEFAULTVALUE_BISHOP_PAIR_OPENING  (45)
#define DEFAULTVALUE_BISHOP_PAIR_ENDGAME  (50)
